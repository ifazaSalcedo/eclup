...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
        ...
        @ExceptionHandler(ProductoIdExistException.class)
        public ResponseEntity<ErrorDetails> handlerProductoIdExistException(ProductoIdExistException exception, WebRequest webRequest){
            ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(),
             exception.getMessage(),
              webRequest.getDescription(false)
              , "PRODUCT_ID_EXIST");
